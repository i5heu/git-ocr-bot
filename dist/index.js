...
var server = http_1.default.createServer(function (req, res) {
    ...
    bob().then(function (el) { return res.end('>>>>' + el); });
});
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, worker.recognize('https://tesseract.projectnaptha.com/img/eng_bw.png')];
                case 4:
...
var worker = tesseract_js_1.createWorker({
